...
// spawnProbe continuously calls Probe() and OnStatusUpdateStatus(), waiting
// for the defined interval between invocations, until Collector.Close() is
// called. Probe() is called without wait on the when first calling this
// function.
